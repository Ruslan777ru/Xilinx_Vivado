...
HD_PWD='D:/Xilinx Vivado/Vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basic_gates_from_example.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basic_gates_from_example.tcl -notrace
