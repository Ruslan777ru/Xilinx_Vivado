...
HD_PWD='D:/Xilinx Vivado/Vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basic_gates_from_example.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basic_gates_from_example.tcl
